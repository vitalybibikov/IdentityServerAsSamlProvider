...
namespace IdentityServerAspNetIdentity
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication()
                .AddSaml2p( options =>
                {
                    ...
                    {
                        EntityId = "http://localhost:7001",
                        SigningCertificates = new List<X509Certificate2>()
                        {
                            GetOwnCert()
                        },
                        SingleSignOnEndpoint = new SamlEndpoint("http://localhost:7001/saml/sso",
                            SamlBindingTypes.HttpPost),
                        SingleLogoutEndpoint = new SamlEndpoint("http://localhost:7001/saml/slo",
                            SamlBindingTypes.HttpRedirect),
                    };
        ...
        private static X509Certificate2 GetIdPCert()
        {
            // key from metadata endpoint of SAML IdP
            var key =
                "";
